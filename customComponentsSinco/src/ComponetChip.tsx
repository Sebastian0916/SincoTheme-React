    ...
    <>
      <Stack mt={2} gap={2} alignItems="center">
        <div style={{ display: "flex", gap: 10 }}>
          <Chip color="primary" label="chip" size="small" />
          ...
          <Chip
            ...
            label="Avatar"
          />
          <Chip variant="outlined" color="primary" label="chip" size="small" />
        ...
        <div style={{ display: "flex", gap: 10 }}>
          <Chip color="secondary" label="chip" size="small" />
          ...
          <Chip
            ...
            label="Avatar"
          />
          <Chip variant="outlined" color="secondary" label="chip" size="small" />
        ...
        <div style={{ display: "flex", gap: 10 }}>
          ...
          <Chip
            ...
            label="Avatar"
          />
          <Chip variant="outlined" color="error" label="chip" size="small" />
        ...
        <div style={{ display: "flex", gap: 10 }}>
          ...
          <Chip
            ...
            label="Avatar"
          />
          <Chip variant="outlined" color="info" label="chip" size="small" />
        ...
        <div style={{ display: "flex", gap: 10 }}>
          ...
          <Chip
            ...
            label="Avatar"
          />
          <Chip variant="outlined" color="success" label="chip" size="small" />
        ...
        <div style={{ display: "flex", gap: 10 }}>
          ...
          <Chip
            ...
            label="Avatar"
          />
          <Chip variant="outlined" color="warning" label="chip" size="small" />
